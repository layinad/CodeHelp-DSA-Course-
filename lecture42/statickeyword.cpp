...
int main()
{
    ...
    Hero a;
    cout<<a.timeToComplete<<endl;          //will also give the result but is not recommended

    Hero b;
    b.timeToComplete=10;                   // Note this will successfully manipulate the static member value but it is not recommended
