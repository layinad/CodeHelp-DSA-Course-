...
{
    Male m1;
    // cout<<m1.height<<endl;                 // NOTE: Error cause we are trying to access height a protected member which was inherited by male class in private mode from human class
